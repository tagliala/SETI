SETI.messages = {
  ...
  player1_stamina_bad_se: SETI.format("There is a very little chance that Player 1, playing as a defender, could generate a bad stamina event at or after minute {0}."),
  player2_stamina_bad_se: SETI.format("There is a very little chance that Player 2, playing as a defender, could generate a bad stamina event if he enters the field at or before minute {0}."),
  ...
  validation_errors: SETI.format("Please correct the following {0} errors:"),
  refresh_throttle: SETI.format("Data not refreshed. Please wait {0} seconds before next request."),
  status_ok: "OK",
  status_error: "Error",
