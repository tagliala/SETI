...
(function() {
  ...
  ClippableBehavior = (function() {
    ...
    ClippableBehavior.prototype.initializeBridge = function() {
      ...
      if (this.flashBridge.length === 0) {
        ...
        this.flashBridge.attr("data-original-title", SETI.messages.copy_to_clipboard);
        this.flashBridge.attr("data-copied-hint", SETI.messages.copied_to_clipboard);
        this.flashBridge.attr("data-copy-hint", SETI.messages.copy_to_clipboard);
        ...
        this.flashBridge.on("clippable:copied", function() {
          ...
          $element.tooltip("show");
          return SETI.ClippableBehavior.handleCopied();
        });
  ...
  SETI.ClippableBehavior.handleCopied = function() {
  ...
  $(function() {
    return $(this).find(".js-clippy").each(function() {
      return new SETI.ClippableBehavior(this);
    });
  });
